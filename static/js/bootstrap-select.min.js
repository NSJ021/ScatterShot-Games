    ...
    !(function (a) {
        ...
        var t = {
            ...
            w =
                ...
                function (b, c) {
                    var d = this;
                    i.useDefault || ((a.valHooks.select.set = i._set), (i.useDefault = !0)),
                        (this.$element = a(b)),
        ...
        (w.VERSION = '1.13.0-beta'),
            ...
            '4' === s.major && ((w.DEFAULTS.style = 'btn-light'), (w.DEFAULTS.iconBase = ''), (w.DEFAULTS.tickIcon = 'bs-ok-default')),
            (w.prototype = {
                constructor: w,
                init: function () {
                    var a = this,
                    ...
                    this.$element.addClass('bs-select-hidden'),
                        ...
                        !0 === this.options.dropdownAlignRight && this.$menu.addClass(t.MENURIGHT),
                ...
                getSelectPosition: function () {
                    ...
                    c.options.container && !f.is('body')
                        ? ((b = f.offset()), (b.top += parseInt(f.css('borderTopWidth'))), (b.left += parseInt(f.css('borderLeftWidth'))))
                        : (b = {
                              top: 0,
                              left: 0,
                          });
                ...
                setMenuSize: function (a) {
                    ...
                    'auto' === this.options.dropdownAlignRight && this.$menu.toggleClass(t.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.$menu[0].offsetWidth - i),
                        this.$menu.css({
                            'max-height': f + 'px',
                            overflow: 'hidden',
                            'min-height': d + 'px',
                ...
                selectPosition: function () {
                    ...
                    var b,
                        ...
                        g = function (a) {
                            var g = {};
                            e.$bsContainer.addClass(a.attr('class').replace(/form-control|fit-width/gi, '')).toggleClass(t.DROPUP, a.hasClass(t.DROPUP)),
                                (b = a.offset()),
                                f.is('body')
                                    ? (c = {
                                          top: 0,
                                ...
                                s.major < 4 && ((g.top = b.top - c.top + d), (g.left = b.left - c.left)),
                ...
                checkDisabled: function () {
                    var a = this;
                    this.isDisabled() ? (this.$newElement.addClass(t.DISABLED), this.$button.addClass(t.DISABLED).attr('tabindex', -1).attr('aria-disabled', !0)) : (this.$button.hasClass(t.DISABLED) && (this.$newElement.removeClass(t.DISABLED), this.$button.removeClass(t.DISABLED).attr('aria-disabled', !1)), -1 != this.$button.attr('tabindex') || this.$element.data('tabindex') || this.$button.removeAttr('tabindex')),
                                    ...
                                    if ((m.prop('selected', !n), g === b.activeIndex && (d = !0), d || ((b.prevActiveIndex = b.activeIndex), (b.activeIndex = void 0)), b.setSelected(g, !n), e.blur(), !1 !== p || !1 !== q)) {
                                        ...
                                        if ((p && r) || (q && s))
                                            if (p && 1 == p) l.prop('selected', !1), m.prop('selected', !0), b.$menuInner.find('.selected').removeClass('selected'), b.setSelected(g, !0);
                                                ...
                                                w[2] && ((x = x.replace('{var}', w[2][p > 1 ? 0 : 1])), (y = y.replace('{var}', w[2][q > 1 ? 0 : 1]))),
                                                    m.prop('selected', !1),
                                                    b.$menu.append(z),
                                                    p && r && (z.append(a('<div>' + x + '</div>')), (k = !1), b.$element.trigger('maxReached.bs.select')),
                                                    q && s && (z.append(a('<div>' + y + '</div>')), (k = !1), b.$element.trigger('maxReachedGrp.bs.select')),
                                                    setTimeout(function () {
                                                        b.setSelected(g, !1);
                                                    }, 10),
        ...
        (a.fn.selectpicker = f),
            ...
            a(document)
                ...
                .on('keydown.bs.select', '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bs-searchbox input', w.prototype.keydown)
